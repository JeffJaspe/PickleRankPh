  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'rankings/amateur', name: 'rankings-amateur', component: () => import('@/features/common/views/PlaceholderView.vue') },
        { path: 'matches', redirect: '/matches/local' },
        { path: 'matches/local', name: 'matches-local', component: () => import('@/features/common/views/PlaceholderView.vue') },
        { path: 'matches/national', name: 'matches-national', component: () => import('@/features/common/views/PlaceholderView.vue') },
        { path: 'matches/club-leagues', name: 'matches-club-leagues', component: () => import('@/features/common/views/PlaceholderView.vue') },
        { path: 'courts', redirect: '/courts/open-play' },
        { path: 'courts/open-play', name: 'courts-open-play', component: () => import('@/features/common/views/PlaceholderView.vue') },

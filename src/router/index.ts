  ...
  routes: [
    {
      ...
      children: [
        { path: '', name: 'home', component: () => import('@/features/rankings/views/RankingsView.vue') },
        { path: 'rankings', name: 'rankings', component: () => import('@/features/rankings/views/RankingsView.vue') },
